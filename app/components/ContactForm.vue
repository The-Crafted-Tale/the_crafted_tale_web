<template>
  <form class="contact-form" novalidate @submit.prevent="handleSubmit">
    ...
    <AppButton type="submit" size="lg" :loading="loading" :disabled="loading">Send Message</AppButton>
  </form>
</template>
...
const form = reactive({
  ...
  email: "",
  phone: "",
  message: props.prefillProduct ? `Hi, I'm inquiring about ${props.prefillProduct}` : "",
})
