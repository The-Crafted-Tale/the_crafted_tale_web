      ...
      <div class="app-footer__inner">
         <div class="app-footer__grid">
            <div class="app-footer__brand">
               ...
               <p class="app-footer__tagline">
                  Your tale, to your loved ones
               </p>
               <p class="app-footer__desc">
                  Every piece tells a story. We create personalized, handmade gifts that capture
                  your most cherished moments and deliver them with care.
               </p>
            </div>

            <div class="app-footer__links-col">
               <h2 class="app-footer__col-title">
                  Quick Links
               </h2>
               <nav class="app-footer__nav" aria-label="Footer navigation">
                  <NuxtLink to="/" class="app-footer__link">
                     Home
                  </NuxtLink>
                  <NuxtLink to="/products" class="app-footer__link">
                     Products
                  </NuxtLink>
                  <NuxtLink to="/about" class="app-footer__link">
                     About
                  </NuxtLink>
                  <NuxtLink to="/contact" class="app-footer__link">
                     Contact
                  </NuxtLink>
               </nav>
            </div>
            ...
            <div class="app-footer__newsletter-col">
               ...
               <form class="app-footer__newsletter" @submit.prevent="handleSubscribe">
                  <input v-model="newsletterEmail" type="email" placeholder="Your email"
                     class="app-footer__newsletter-input" aria-label="Email for newsletter"
         ...
         <div class="app-footer__bottom">
            <p class="app-footer__copy">
               &copy; {{ currentYear }} The Crafted Tale. All rights reserved.
            </p>
            <div class="app-footer__legal">
               <NuxtLink to="/privacy" class="app-footer__legal-link">
                  Privacy Policy
               </NuxtLink>
               <NuxtLink to="/terms" class="app-footer__legal-link">
                  Terms of Service
               </NuxtLink>
            </div>
         </div>
...
const newsletterButtonText = computed(() => {
  if (newsletterState.value === 'loading') {
    return 'Sending...'
  }

  if (newsletterState.value === 'success') {
    return 'Subscribed!'
  }
