   ...
   <div class="header-wrap" :class="{ 'header-wrap--scrolled': scrolled }">
      ...
      <Teleport to="body">
         <Transition name="drawer">
            <div v-if="drawerOpen" id="mobile-drawer" class="app-header__drawer-overlay"
               @click.self="drawerOpen = false" @keydown="handleDrawerKeydown">
               <nav ref="drawerRef" class="app-header__drawer" aria-label="Mobile navigation">
                  <div class="app-header__drawer-header">
                     <AppLogo size="sm" />
                     <button class="app-header__drawer-close" aria-label="Close navigation menu"
